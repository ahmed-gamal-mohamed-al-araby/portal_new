...
class UpdateSupplierRequest extends FormRequest
{
    ...
    {
        return [
            'name_ar' => ['required', 'max:255', 'unique:suppliers,name_ar,' . $this->supplier->id],
            'name_en' => ['required', 'max:255', 'unique:suppliers,name_en,' . $this->supplier->id],
            ...
            'email' => ['nullable', 'max:255', 'unique:suppliers,email,' . $this->supplier->id],
            'fax' => ['nullable', 'max:25'],
            'gmap_url' => ['nullable', 'url', 'max:520'],
            'website_url' => ['nullable', 'url', 'max:520'],
            'tax_id_number' => ['required', 'max:11', 'unique:suppliers,tax_id_number,' . $this->supplier->id],
            'commercial_registeration_number' => ['required', 'min:4', 'max:7'],
            'value_add_registeration_number' => ['nullable', 'max:11', 'unique:suppliers,value_add_registeration_number,' . $this->supplier->id],
