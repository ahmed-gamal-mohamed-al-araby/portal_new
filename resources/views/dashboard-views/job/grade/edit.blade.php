...
{{-- Custom Title --}}
@section('title')
    @lang('site.Edit') @lang('site.the_job_grade')
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Edit') @lang('site.Job_grades')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-layout">
                        {{-- Form to edit Job grade --}}
                        <form action="{{ route('job-grade.update', $jobGrade->id) }}" method="POST"
                            id="editJobGrade">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" max="29" name="grade" value="{{ $jobGrade->grade }}"
                                            class="form-control" placeholder="@lang('site.Job_grade')">
                                    </div>
                                    @error('grade')
                                        ...
                                        <select id='jobCode' name="job_code_id" class="form-control" style="width: 100%;">
                                            ...
                                            @foreach ($jobCodes as $jobCode)
                                                <option value="{{ $jobCode->id }}"
                                                    {{ $jobGrade->jobCode->id ==$jobCode->id ? 'selected' : '' }}>
                                                    {{ $jobCode->code }}</option>
                                            @endforeach
                                        </select>
                                    </div>
