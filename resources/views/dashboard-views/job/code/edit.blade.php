...
{{-- Custom Title --}}
@section('title')
    @lang('site.Edit') @lang('site.the_job_code')
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Edit') @lang('site.Job_codes')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-layout">
                        {{-- Form to edit Job code --}}
                        <form action="{{ route('job-code.update', $jobCode->id) }}" method="POST"
                            id="editJobCode">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" value="{{ $jobCode->code }}"
                                        ...
                                        <select id='department' name="department_id" class="form-control" style="width: 100%;">
                                            ...
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    {{ $jobCode->department->id ==$department->id ? 'selected' : '' }}>
