...
{{-- Custom Title --}}
@section('title')
    @lang('site.Add') @lang('site.discountTypes')
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('discountTypes.index') }}">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("discountTypes.store")}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
