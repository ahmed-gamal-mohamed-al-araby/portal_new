...
{{-- Custom Title --}}
@section('title')
@lang('site.Edit') @lang('site.user_role')
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> @lang('site.Edit') @lang('site.user_role')</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-layout">
                    ...
                    <form action="{{ route('user-roles.update', $username_id) }}" method="POST" id="">
                        @csrf
                        @method('put')
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group ">
                                    ...
                                    <select id='user' name="user_id" class="form-control users" style="width: 100%;">
                                        ...
                                        <option value="{{ $user->id }} " @if($username_id == $user->id) selected @endif>
                                            {{ $user->name_ar }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group ">
                                    ...
                                    <select id='role' name="role_id[]" class="form-control roles" multiple style="width: 100%;">
                                        ...
                                        <option value="{{ $role->id }}" @if(in_array($role->id, $roles_select)) selected @endif>
                                            {{ $role->name }}
                                        </option>
                                        @endforeach
                                    </select>
