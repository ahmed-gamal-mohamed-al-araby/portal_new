...
'parent' => 'approval_orders_timeline',
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('site.timelinePO')</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header show-approval parent">
                            <h6 class="float-left mb-0">@lang('site.timelinePO')</h6>
                        </div>
                        ...
                        {{-- Table length filter --}}
                            ...
                            <div id="table-data" class="table-responsive">
                                @include('dashboard-views.approval.pagination_data_order', ['pageType' => 'index'])
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        const fetchDataURL =
            "{{ route('approval.pagination.fetch_data_orders') }}", // This valriable used in pagination_script
            pageType = 'index';
