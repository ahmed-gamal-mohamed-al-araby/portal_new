...
'parent' => 'approval_timeline_order',
// 'child' => 'timeline',
])
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                               {{-- order_number --}}
                    <div class="col-md-12">
                        <h2 class="text-center mb-3"> @lang('site.order_number'): <span>{{ $purchaseOrder->order_number }}</span></h2>
                    </div>
                                    {{-- Date --}}
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" id="date" class="form-control" readonly value="{{$created_at}}">
                        @if ($errors->has('date'))
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input value="{{ $user['name_' . $currentLanguage] }}"
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                            <span class="input-group-text"
                                id="inputGroup-sizing-sm">@lang('site.Supplier')</span>
                        </div>
                        <input value="{{ $purchaseOrder->supplier['name_' . $currentLanguage] }}"
                            class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                            <span class="input-group-text"
                                id="">@lang('site.Phone')</span>
                        </div>
                        <input value="{{  $purchaseOrder->supplier->phone }}"
                            class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                            <span class="input-group-text"
                                id="inputGroup-sizing-sm">@lang('site.Fax')</span>
                        </div>
                        <input value="{{ $purchaseOrder->supplier->fax }}"
                            class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                            <span class="input-group-text"
                                id="inputGroup-sizing-sm">@lang('site.Email')</span>
                        </div>
                        <input value="{{ $purchaseOrder->supplier->email }}"
                            class="form-control" readonly>
                    </div>
                </div>

                {{-- Creator Purchase Order --}}
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                            <span class="input-group-text"
                                id="inputGroup-sizing-sm">@lang('site.purchase_requests')</span>
                        </div>
                        <input value=" @foreach ($purchaseRequestID as $puID)@if (count($purchaseRequestID) > 1)+@endif{{$puID}}@endforeach "
                            class="form-control" readonly>
                    </div>
                </div>
                ...
                {{-- <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input
                            class="form-control" readonly value="{{ $department['name_' . $currentLanguage] }}">
                ...
                {{-- <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input
                            class="form-control" readonly value="{{ $PurchaseRequest->request_number }}">
                        <input type="hidden" name="department_id"
                            value="">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input
                            class="form-control" readonly value="{{$project['name_' . $currentLanguage] }}">
                ...
                @endif --}}
                            ...
                            <main class="stepline mt-4">
                                <div class="item d-flex">
                                    ...
                                    <h5>({{ $purchaseOrder->requester['name_'.$currentLanguage] }})</h5>
                                ...
                                @php
                                    $idBusiness = App\Models\ApprovalTimeline::where( "table_name" ,"purchase_orders")->where("record_id",$purchaseOrder->id)->where("business_action",2)->first();
                                @endphp
                                @if ($idBusiness)
                                        <div class="item d-flex">
