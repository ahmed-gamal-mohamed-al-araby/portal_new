                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('approvals.index') }}">@lang('site.Approval_cycles')</a></li>
                    ...
                    <div class="col-md-2"></div> --}}
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-2">
                                        ...
                                        <input value="{{ $purchaseOrder->requester['name_' . $currentLanguage] }}"
                                ...
                                @if ($purchaseOrder->sector)
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-2">
                                            ...
                                            <input value="{{ $purchaseOrder->sector['name_' . $currentLanguage] }}"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($purchaseOrder->department)
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-2">
                                            ...
                                            <input value="{{ $purchaseOrder->department['name_' . $currentLanguage] }}"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($purchaseOrder->project)
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-2">
                                            ...
                                            <input value="{{ $purchaseOrder->project['name_' . $currentLanguage] }}"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-2">
                                        <div class="input-group-prepend">
                                            <span style="width: 100px;" class="input-group-text"
                                                id="inputGroup-sizing-sm">@lang('site.Classification')</span>
                                        </div>
                                        <input value="{{ $purchaseOrder->group['name_' . $currentLanguage] }}"
                                            class="form-control" readonly>
                                    </div>
                                </div>
                                ...
                                @if ($purchaseOrder->client_name)
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-2">
                                            <div class="input-group-prepend">
                                                <span style="width: 100px;" class="input-group-text"
                                                    id="inputGroup-sizing-sm">@lang('site.client_name')</span>
                                            </div>
                                            <input value="{{ $purchaseOrder->client_name }}" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($purchaseOrder->manufacturing_order_number)
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-2">
                                            <div class="input-group-prepend">
                                                <span style="width: 100px;" class="input-group-text"
                                                    id="inputGroup-sizing-sm">@lang('site.manufacturing_order_number')</span>
                                            </div>
                                            <input value="{{ $purchaseOrder->manufacturing_order_number }}"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                @if ($value == 0)
                                @php
                                $approveltimeline = App\Models\ApprovalTimeline::where('record_id', $purchaseOrder->id)
                                    ->where('approval_status', 'P')
                                    ->first();
                            @endphp
                                    <div class="modal fade text-center" id="confirm_modal{{ $approveltimeline->id }}"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modal-title">
                                                        @lang('site.approval_approval_title')</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('approvals.action.approve.comment') }}"
                                                            ...
                                                            @if (auth()->user()->sector->name_en == 'Purchasing')
                                                                <div class="row purchase_type_top approve_only">
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="radio" name="purchase_type"
                                                                            class="form-control purchase_type"
                                                                            value="purchase_out">
                                                                        </div>
                                                                    <div class="col">
                                                                        <label for="">@lang("site.purchase_in")</label>
                                                                        <input type="radio" checked name="purchase_type"
                                                                            class="form-control purchase_type"
                                                                            value="purchase_in">
                                                                        </div>
                                                                    <div class="col">
                                                                        ...
                                                                        <input type="radio" name="purchase_type"
                                                                            class="form-control purchase_type" value="both">
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div class="d-flex approve_only">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="radio" name="skip_stage"
                                                                            class="form-control skip_stage" value="skip">
                                                                        </div>
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="">@lang("site.manager_approval")</label>
                                                                        <input type="radio" checked name="skip_stage"
                                                                            class="form-control skip_stage"
                                                                            value="not_skip">
                                                                        </div>
                                                                </div>
                                                            @endif
                                                        ...
                                                        <input type="hidden" name="approval_id" id="approval_id"
                                                            value="{{ $approveltimeline->id }}">
                                                        <button type="button" class="btn btn-outline-dark"
                                                            data-dismiss="modal"> @lang('site.No') ,
                                                            @lang('site.Cancel')</button>
                                                        <button type="submit" class="btn btn-outline-dark">
                                                            @lang('site.Yes') , @lang('site.Approve') <span
                                    ...
                                    <form action="{{ route('approve.order.items') }}" method="POST">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <a data-approval_time="{{ $approveltimeline->id }}" data-type='approval'
                                                data-toggle="modal"
                                                data-target="#confirm_modal{{ $approveltimeline->id }}"
                                                class="btn btn-success d-inline-block" data-pur="purchase_requests"
                                                data-toggle="modal" tooltip="@lang('site.approve_comment')"><i
                                ...
                                <table class="table table-responsive table-bordered table-responsive" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($itemsorders as $itemsorder)
                                            <tr class="@if ($itemsorder->used_quantity == 0) complete @endif">
                                                <th scope="row">{{ $i++ }}</th>
                                                <!-- <td class="a">
                                                ...
                                                @if ($message == 3)
                                                    <td style="width: 50%;">
                                                        <input type="text" class="form-control"
                                                            value="{{ $itemsorder->specification }}"
                                                            name="specification[]">
                                                    </td>
                                                @else
                                                ...
                                                @if ($purchaseOrder->client_name)
                                                    <td style="width: 50%;">{{ $itemsorder->factory_specification }}
                                                    </td>
                                                @endif
                                                        ...
                                                        <div class="timeline-item">
                                                            <div class="timeline-body">
                                                                <a class="btn btn-success mb-2" style="font-size: 12px"
                                                                    href="{{ asset("uploaded-files/pr/$itemsorder->file") }}"
                                                ...
                                                @if ($value == 0)
                                                    <td>
                                                        ...
                                                        <input checked type="checkbox" name="status_check"
                                                            class=" d-block status_check" id="">
                                                    </td>
                                                @elseif ($message == 3)
                                                    <td>
                                                        <input type="hidden"
                                                            value="{{ App\Models\ApprovalTimeline::where('id', $id)->first()->record_id }}"
                                                            name="purchase_request_id">
                                                        <input type="hidden" name="ids[]" value="{{ $itemsorder->id }}">
                                ...
                                <div class="card-body">
                                    ...
                                    @forelse ($files as $file)
                                        <a class="btn btn-success mb-2"
                                            href="{{ asset("uploaded-files/pr/$file->file") }}"
                                            ...
                                            @if ($managerProject != 'PRO_M')
                                                <div class="col">
                                                    ...
                                                    <h6 class="text-success " style="margin-bottom:2px;font-size:9px;">
                                                        ...
                                                        @elseif($timeline->approval_status == 'A')
                                                            @lang('site.approval_status_approved')
                                                            <i class="fas fa-check text-success"></i>
                                                        @elseif($timeline->approval_status == 'RV')
                                                            @lang('site.approval_status_reverted')
                                                            <i class="fas fa-undo-alt text-danger"></i>
                                                        @elseif($timeline->approval_status == 'RJ')
                                                            @lang('site.approval_status_rejected')
