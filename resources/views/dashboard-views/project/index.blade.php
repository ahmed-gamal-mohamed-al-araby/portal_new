            ...
            <div class="col-12">
                <div class="row mb-3 justify-content-between">
                    ...
                    <div class="col-8 d-flex justify-content-end">
                        ...
                        <a href="{{ route('project.trash') }}" class="btn btn-warning header-btn mx-2">@lang('site.Trashed_projects')
                            <span class="main-span"><span>
                        </a>
                        @endif
                        @if(auth()->user()->can('complete-project'))

                        <a href="{{ route('project.completed_index') }}" class="btn btn-warning header-btn ">@lang('site.Completed_projects')
                            <span class="main-span"><span>
                        </a>
                        @endif
