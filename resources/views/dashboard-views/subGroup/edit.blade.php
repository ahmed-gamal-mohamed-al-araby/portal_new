...
{{-- Custom Title --}}
@section('title')
    @lang('site.Edit') @lang('site.the_sub_group')
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> @lang('site.Edit') @lang('site.sub_group')</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-layout">
                        ...
                        <form action="{{ route('sub-group.update', $subGroup->id) }}" method="POST" id="editSubGroup">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" value="{{ $subGroup->name_ar }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en"value="{{ $subGroup->name_en }}"
                                        ...
                                        <select id='group' name="group_id" class="form-control"
                                            ...
                                            @foreach ($groups as $group)
                                                <option value="{{ $group->id }}"
                                                    {{ $subGroup->group->id == $group->id ? 'selected' : '' }}>
