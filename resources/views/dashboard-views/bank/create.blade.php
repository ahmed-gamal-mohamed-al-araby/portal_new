        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('banks.index') }}">
                            @lang('site.banks')</a>
                    </li>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("banks.store")}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="bank_ibn" value="{{ old('bank_ibn') }}" class="form-control" id="">
                                                @error('bank_ibn')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="bank_swift" value="{{ old('bank_swift') }}" class="form-control" id="">
                                                @error('bank_swift')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
